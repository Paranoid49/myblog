...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(output_dir / "task17-admin-login.png"), full_page=True)
    ...
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-admin-post-list.png"), full_page=True)

    page.click('a[href="/admin/posts/new"]')
    page.wait_for_url("**/admin/posts/new")
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-admin-new-post.png"), full_page=True)
    ...
    page.wait_for_url("**/admin/posts")
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-admin-post-list-after-create.png"), full_page=True)

    page.click('a[href^="/admin/posts/"][href$="/edit"]')
    page.wait_for_url("**/edit")
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-admin-edit-post.png"), full_page=True)
    ...
    page.wait_for_url("**/admin/posts")
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-admin-post-list-after-edit.png"), full_page=True)

    page.goto("http://127.0.0.1:8001/")
    page.wait_for_load_state("networkidle")
    page.screenshot(path=str(output_dir / "task17-public-home.png"), full_page=True)
